...
class SimulatedExecution:
    ...
    def __init__(
        ...
        self._latest_bar_time: Dict[str, datetime] = {}  # symbol -> bar timestamp
        self._fill_count = 0
    ...
    def _track_prices(self, event: MarketDataEvent) -> None:
        ...
        self._latest_bar_time[event.symbol] = event.bar_timestamp or event.timestamp
    ...
    def on_order(self, order: OrderEvent) -> None:
        ...
        fill = FillEvent(
            ...
            timestamp=self._latest_bar_time.get(order.symbol, order.timestamp),
        )
